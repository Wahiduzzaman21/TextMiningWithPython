...
if configdf['TrainData'][0] == 'Sports':
    ...
    df = pd.read_csv("./data/content/international/InternationalCleanContentForMultilabelClassification.csv",
                     encoding="utf-8-sig")
    tag_list_df = pd.read_csv("./data/uniquetags/InternationalTag.csv", encoding="utf-8-sig")
elif configdf['TrainData'][0] == 'Bangladesh':
    df = pd.read_csv("./data/content/bangladesh/BangladeshCleanContentForMultilabelClassification.csv",
                     encoding="utf-8-sig")
    ...
    df = pd.read_csv("./data/content/entertainment/EntertainmentCleanContentForMultilabelClassification.csv",
                     encoding="utf-8-sig")
...
vector_transformer_model_load_path = "./model/TrainedModel/TfIdfTransformer/" + configdf['VectorName'][0] + \
    ...
    configdf['Vectorsize'][0]) + "/" + "TfIdfTransformer.pkl"
...
model.fit(X_train, y_train, batch_size=200, epochs=200, verbose=1, validation_split=0.2)
...
model.save("./model/TrainedModel/MultilabelClassifier/NN/" + configdf['VectorName'][0] + \
           "/" + configdf['TrainData'][0] + "/" + str(configdf['Vectorsize'][0]))
